# Graph Report - docs/src-eurocommemo  (2026-07-09)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 3492 nodes · 5297 edges · 329 communities (172 shown, 157 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7245dbe0`
...
- `LivraisonType` --inherits--> `AddressType`  [EXTRACTED]
  src/Form/Order/LivraisonType.php → src/Form/Profile/AddressType.php
- `AddressType` --inherits--> `ProfileType`  [EXTRACTED]
  src/Form/Profile/AddressType.php → src/Form/Profile/ProfileType.php
- `OrderType` --inherits--> `AddressType`  [EXTRACTED]
  src/Form/Order/OrderType.php → src/Form/Profile/AddressType.php
- `RegistrationFormType` --inherits--> `ProfileType`  [EXTRACTED]
  src/Form/RegistrationFormType.php → src/Form/Profile/ProfileType.php

## Import Cycles
- None detected.

## Communities (329 total, 157 thin omitted)
...
Cohesion: 0.07
Nodes (36): ProductCrudController, CreateOnEbayUseCase, DeleteEbayUseCase, FilterInterface, NullFilter, StringLengthFilter, FilterTrait, GetDeliveryShippingUseCase (+28 more)
...
Cohesion: 0.06
Nodes (10): DateTimeInterface, ShippingService, OrderAddress, File, FulfillmentShipToDTO, self, FulfillmentShipToDTO, Order (+2 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (25): ItemClosedEvent, ItemRevisedEvent, PaymentReceiveEvent, OrderListener, FulfillmentLineItemDTO, ImportBuyerDTO, OnFlushEventArgs, StockManagementService (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (9): addElementFromTemplate(), _createElementFromTemplate(), data(), initialize(), _randomString(), ElementForm, ICONS, ElementFormMounter (+1 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (3): Order, User, User

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (32): Actions, OrderCrudController, AdminContext, BatchActionDto, BinaryFileResponse, Crud, ShippingServiceCrudController, EbayTradingAPI (+24 more)
...
Cohesion: 0.08
Nodes (4): CreateProductInput, ProductImage, UpdateProductUseCase, Product
...
Cohesion: 0.11
Nodes (13): ShippingProviderRepository, CartRepository, FooterRepository, NewsletterRepository, ProductNotationRepository, WebhookLogRepository, ServiceEntityRepository, ManagerRegistry (+5 more)

### Community 24 - "Community 24"
Cohesion: 0.10
Nodes (4): DateTimeImmutable, FulfillmentOrderDTO, FulfillmentAmountDTO, FulfillmentShipToDTO
...
Cohesion: 0.18
Nodes (14): ImportEbayOrderCommand, Country, ItemSoldDTO, PaymentReceiveEventDTO, ShippingCostDTO, Country, DateTime, InputInterface (+6 more)
...
Cohesion: 0.17
Nodes (10): Command, DefineDefaultTitleEbayCommand, ListEbayShippingServicesCommand, UpdateCountryCommand, InputInterface, OutputInterface, InputInterface, OutputInterface (+2 more)
...
Cohesion: 0.16
Nodes (4): MailService, Order, ProductAlert, User

### Community 42 - "Community 42"
Cohesion: 0.25
Nodes (9): CodeField, LimitPerUserField, LimitUsageField, MontantReductionField, TypeReductionField, FieldInterface, FieldTrait, self (+1 more)

### Community 43 - "Community 43"
Cohesion: 0.29
Nodes (9): GetEbayFulfillmentOrderCommand, InputInterface, OutputInterface, FulfillmentOrderDTO, FulfillmentShipToDTO, InputInterface, Order, OrderAddress (+1 more)
...
Cohesion: 0.18
Nodes (6): AbstractController, BuilderController, HomePageController, MenuController, Response, Response
...
Cohesion: 0.19
Nodes (9): AbstractDashboardController, DashboardController, Assets, Dashboard, Response, Tva, Assets, Response (+1 more)
...
Cohesion: 0.16
Nodes (4): OrderProducts, CartHelper, OrderProducts, Order

### Community 58 - "Community 58"
Cohesion: 0.19
Nodes (7): FormEvent, OrderType, AddressType, FormBuilderInterface, OptionsResolver, FormBuilderInterface, OptionsResolver
...
Cohesion: 0.14
Nodes (7): Exception, ConvertException, CountryNotFoundException, EbayCreateErrorException, EbayOrderAlreadyImportedException, EbayProductsMissingException, ExternalEbayApiException
...
Cohesion: 0.22
Nodes (5): OrderRepository, CodeReduction, DateTime, ManagerRegistry, User
...
Cohesion: 0.24
Nodes (6): AbstractType, CountryZoneCommuneType, CategoryChooseEbayType, FormBuilderInterface, OptionsResolver, FormBuilderInterface
...
Cohesion: 0.42
Nodes (4): CartController, OrderRepository, JsonResponse, Request
...
Cohesion: 0.25
Nodes (3): Version20260708190052, Version20260708224710, Schema
...
Cohesion: 0.22
Nodes (4): AccoungApiV1, FulfillmentApiV1, GetEbayConfigurationUseCase, FulfillmentOrderDTO
...
Cohesion: 0.36
Nodes (4): WebhookController, JsonResponse, Request, WebhookMapperEventName

### Community 117 - "Community 117"
Cohesion: 0.33
Nodes (4): ShippingServiceRepository, ManagerRegistry, OrderAddressRepository, ShippingService
...
Cohesion: 0.19
Nodes (6): AbstractCrudController, FaqCrudController, DeliveryShippingCrudController, Crud, Actions, Crud
...
Cohesion: 0.47
Nodes (3): CleanWebhookLogCommand, InputInterface, OutputInterface
...
Cohesion: 0.40
Nodes (4): CodeReduction, static, CodeReduction, static

### Community 175 - "Community 175"
Cohesion: 0.47
Nodes (3): DefineOrderIncrementOnOrderEbayCommand, InputInterface, OutputInterface
...
Cohesion: 0.23
Nodes (5): AbstractMigration, Version20240415074302, Version20260701220045, Schema, Schema

### Community 263 - "Community 263"
Cohesion: 0.47
Nodes (3): LivraisonType, FormBuilderInterface, OptionsResolver
...
## Knowledge Gaps
- **172 isolated node(s):** `$`, `$`, `containerPaymentMode`, `$`, `$` (+167 more)
...
- **Why does `CategoryRepository` connect `Community 98` to `Community 1`, `Community 2`, `Community 289`, `Community 134`, `Community 71`, `Community 12`, `Community 45`, `Community 79`, `Community 81`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Order` connect `Community 6` to `Community 294`, `Community 13`, `Community 174`, `Community 50`, `Community 181`, `Community 118`, `Community 53`, `Community 57`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `ProductImage` connect `Community 14` to `Community 1`, `Community 187`, `Community 54`?**
